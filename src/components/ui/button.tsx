  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: 
          "bg-secondary text-secondary-foreground font-semibold shadow-lg hover:shadow-xl hover:scale-105 active:scale-100",
        heroOutline:
          "border-2 border-secondary/80 bg-transparent text-secondary hover:bg-secondary/10 hover:border-secondary",
        accent:
          "bg-accent text-accent-foreground shadow-md hover:bg-accent/90 hover:shadow-lg",
        museum:
          "bg-ghana-black text-secondary font-semibold tracking-wider uppercase hover:bg-ghana-black/90",
      },
      size: {
